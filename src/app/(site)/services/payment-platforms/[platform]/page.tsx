        ...
        <div className="site-container grid gap-14 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 leading-7 text-muted-foreground">
              We help you organize the business context and information commonly considered during a
        ...
        <div className="site-container max-w-4xl">
          ...
          <Accordion type="single" collapsible className="mt-8">
            ...
            <AccordionItem value="issues">
              ...
              <AccordionContent className="leading-7 text-muted-foreground">
                Incomplete or inconsistent documents, unclear business activity, unsupported
                jurisdictions, and verification delays can affect applications.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
          <p className="mt-10 border-l-2 border-primary pl-5 text-sm text-muted-foreground">
            Platform rules and availability change. Always check the provider’s current terms.
            Corevexal is an independent consultancy and does not imply official affiliation.
          </p>
        </div>
      </section>
      <CtaBand />
